...
import com.itunes_search.design.AppColors

// Color palette for Countdown+ default theme
...
internal object DefaultColorPalette : TonalColorPalette {
    ...
    fun primaryColor(isDarkScheme: Boolean) = primaryColor(SWATCH_NAME_DEFAULT, isDarkScheme)
}
